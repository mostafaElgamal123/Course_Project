...
<div class="row pt-4 pb-4">
    <div class="col-xl-8 col-12 mx-auto">
        <form class="style_form" action="{{url('/reviewimages/'.$review->slug)}}" method="post" enctype="multipart/form-data">
        @include('web.dashborad.layout.message')
            @csrf
            @method('PUT')
            <div class="mb-3">
                <label class="form-label">review image</label>
                <input type="file" name="review_image" value="{{$review->review_image}}" class="form-control">
            </div>
            <div class="mb-3">
