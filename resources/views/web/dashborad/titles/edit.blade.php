...
<div class="row pt-4 pb-4">
    <div class="col-xl-8 col-12 mx-auto">
        <form class="style_form" action="{{url('/titles/'.$title->slug)}}" method="post" enctype="multipart/form-data">
        @include('web.dashborad.layout.message')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="slug" value="{{$title->slug}}" class="form-control">
            </div>
            <div class="mb-3">
