...
<section dir="ltr" class="pt-5 pb-5 container main-title">	
	<div class="row g-4 content align-self-stretch">
...
<h1 class="rounded-pill p-3 fw-bolder text-primary text-center">
		لمده 24 ساعه فقط 999 جنيه بدلا من 3000
</h1>
<!-- end section7 -->
<!-- start footer -->
<footer id="form" class="border border-primary mb-2 p-4">
	<p class="fw-bolder text-center">برجاء كتابه البيانات بشكل كامل , بعدم اكتمال العنوان سوف يلغي ارسال الكورس</p>
		<div class="row g-3">
		<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 col-12">
				<form  id="OrderForm">
					...
					<div class="mb-3">
						...
						<select id="city" name="city" value="{{old('city')}}" class="form-select coursecategory">
